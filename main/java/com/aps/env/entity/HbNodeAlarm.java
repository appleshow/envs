...
public class HbNodeAlarm {
    ...
    public String getItemAlarm() {
        return itemAlarm;
    }

    public void setItemAlarm(String itemAlarm) {
        this.itemAlarm = itemAlarm == null ? null : itemAlarm.trim();
    }
